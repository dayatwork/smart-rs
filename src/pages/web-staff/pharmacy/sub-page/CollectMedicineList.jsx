...
export const CollectMedicineList = ({ parentRoute, backButtonLabel }) => {
  ...
  const columns = React.useMemo(
        ...
        Cell: ({ row }) => {
          return (
            <PrivateComponent permission={Permissions['read-detailReceipt']}>
              <Button
                as={Link}
                to={`${parentRoute}/collect-medicine/${row.original.id}`}
                colorScheme="purple"
                variant="link"
              >
                Details
    ...
    [clipboardValue, hasCopied, onCopy, handleDeliver, parentRoute]
  );
