...
import { getInstitutions } from '../../../../../api/institution-services/institution';
import { BackButton } from '../../../../../components/shared/BackButton';
import { ImagingPatientList } from './ImagingPatientList';
import { ImagingResultList } from './ImagingResultList';
    ...
    <Box>
      ...
      <Tabs mx="auto" overflowX="auto" size="lg" colorScheme="purple">
        ...
        <TabPanels>
          <TabPanel>
            <Box py="6">
              <ImagingPatientList selectedInstitution={selectedInstitution} />
            </Box>
          </TabPanel>
          <TabPanel>
            <Box py="6">
              <ImagingResultList selectedInstitution={selectedInstitution} />
            </Box>
          </TabPanel>
        </TabPanels>
      </Tabs>
