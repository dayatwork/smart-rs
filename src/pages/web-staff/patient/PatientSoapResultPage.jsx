    ...
    <AppShell>
      <Box height="full" overflow="hidden" position="relative" w="full">
        <Flex h="full">
          <ContentWrapper>
            <Box>
              <BackButton to="/patient/history" text="Back to History List" />
              ...
              <Box mb="8">
                ...
                <Box boxShadow="md" bgColor="white" p="4" borderRadius="md">
                  ...
                  <Description
                    title="Date"
                    value={new Date(dataSoap?.data?.date).toLocaleDateString(
                      'id-ID',
                      {
                        day: '2-digit',
                        month: 'long',
                    ...
                    (symptom, index) => (
                      <Box key={symptom.id} pl="4">
                        ...
                        <Description
                          ...
                          value={
                            symptom?.alleviating_and_aggravating_factors || '-'
                          }
                        />
                        <Description
                          title="Radiation"
              ...
              <Box mb="8">
                ...
                <Box boxShadow="md" bgColor="white" p="4" borderRadius="md">
                  ...
                  <Text pl="4">
                    {dataPatientAssessments?.data?.doctor_note}
                  </Text>
                </Box>
              </Box>
              <Box mb="8">
